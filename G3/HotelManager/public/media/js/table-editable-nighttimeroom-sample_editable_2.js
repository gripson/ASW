        ...
        init: function () {
            ...
            $('#sample_editable_2 a.delete').live('click', function (e) {
              ...
              if (confirm("确定要删除吗 ?") == false) {
                ...
                $.ajax({
                    type:"post",
                    url:"/roomnight/deletedtt",//传入action来处理
            ...
            $('#sample_editable_2 a.edit').live('click', function (e) {
                ...
                if (nEditing !== null && nEditing != nRow) {
					...
					$.ajax({
                        type:"post",
                        url:"/roomnight/savett",//传入action来处理
                        data: "roomtype="+aData[0]+"&starttime="+aData[1]+"&endtime="+aData[2]+"&roomprice="+aData[3]+"&ttt="+Math.random(),
                        dataType: "text",
                        error:function(){
                            alert("服务器繁忙，请稍候在试！");
                        },
