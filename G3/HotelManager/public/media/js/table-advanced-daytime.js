var TableAdvanced = function () {
    ...
    var initTable1 = function() {
        ...
        function fnFormatDetails ( oTable, nTr )
        {
            ...
            var sOut = '<table>';
            sOut += '<tr><td>面积:</td><td>'+aData[11]+'</td></tr>';
            sOut += '<tr><td>楼层:</td><td>'+aData[12]+'</td></tr>';
            sOut += '<tr><td>床铺:</td><td>'+aData[13]+'</td></tr>';
            sOut += '<tr><td>房间图片:</td><td>Could provide a link here</td></tr>';
            sOut += '</table>';
