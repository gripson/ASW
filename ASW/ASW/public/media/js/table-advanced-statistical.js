    ...
    var initTable1 = function() {
        ...
        function fnFormatDetails ( oTable, nTr )
        {
           ...
           // sOut += '<tr><td>预定时间:</td><td>'+aData[2]+'</td></tr>';
		    sOut += '<tr><td>预订时间:</td><td>08/20/2013 13:10</td></tr>';
			sOut += '<tr><td>离店时间:</td><td>08/21/2013 13:10</td></tr>';
            sOut += '<tr><td>房间保留时间:</td><td>30分钟</td></tr>';
            sOut += '<tr><td>联系方式:</td><td>18768107112</td></tr>';
            sOut += '<tr><td>备注:</td><td>有小冰箱</td></tr>';
            sOut += '</table>';
